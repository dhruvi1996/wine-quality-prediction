...
public class Constants {
    ...
    // public static final String TRAINING_DATASET = BUCKET_NAME +
    // "TrainingDataset.csv";
    // public static final String VALIDATION_DATASET = BUCKET_NAME +
    ...
    // public static final String TRAINING_DATASET = System.getProperty("user.dir")
    // + "/" + "TrainingDataset.csv";
    // public static final String VALIDATION_DATASET =
    // System.getProperty("user.dir") + "/" + "ValidationDataset.csv";
    // public static final String MODEL_PATH = System.getProperty("user.dir") + "/"
    // + "TrainingModel";
    // public static final String TESTING_DATASET = System.getProperty("user.dir") +
    // "/" +"TestDataset.csv";
